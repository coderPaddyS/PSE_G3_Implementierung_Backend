...
public class AliasMutation implements GraphQLMutationResolver {
    ...
    @Autowired
    public AliasMutation(AliasService aliasService, AliasSuggestionService aliasSuggestionService, DeletedAliasService deletedAliasService, BlacklistService blacklistService) {
